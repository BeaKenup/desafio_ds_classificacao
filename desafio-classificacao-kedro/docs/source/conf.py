...
# desafio_classificacao_kedro documentation build
...
from desafio_classificacao_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "desafio_classificacao_kedro"
author = "Kedro"
...
htmlhelp_basename = "desafio_classificacao_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "desafio_classificacao_kedro.tex",
        "desafio_classificacao_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "desafio_classificacao_kedro",
        "Project desafio_classificacao_kedro codebase.",
        "Data-Science",
    )
]
